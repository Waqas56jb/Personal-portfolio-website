      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1200px] flex justify-between items-center">
        ...
        <div className={`nav-links flex items-center gap-4 sm:gap-6 lg:gap-8 lg:static lg:flex-row lg:w-auto lg:h-auto lg:bg-transparent lg:dark:bg-transparent fixed top-[70px] sm:top-20 left-0 w-full h-[calc(100vh-70px)] sm:h-[calc(100vh-80px)] bg-white dark:bg-[#0b1220] flex-col justify-start pt-8 lg:pt-0 lg:justify-center transition-all z-[999] overflow-y-auto ${
          ...
          <a
            ...
            download
            className="btn-primary px-4 sm:px-5 py-2 sm:py-2.5 rounded-lg font-semibold text-xs sm:text-[0.9rem] bg-primary text-white border-2 border-primary hover:bg-primary-dark hover:border-primary-dark hover:-translate-y-0.5 hover:shadow-md transition-all whitespace-nowrap"
            data-aos="fade-down"
            data-aos-delay="600"
          >
            Download CV
